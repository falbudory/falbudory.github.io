...
var percentWidth = 0;
var heartLeft = -3.2;
var progressLoad = setInterval(progressInterva,50)
...
function progressInterva(){
    if(count == 100 && percentWidth == 100){
        ...
        percent.textContent = "Tình yêu đông đầy rùi đó:)";
        percent.style.letterSpacing = "1px";
        percent.style.width = "400px";
        ...
        setTimeout(()=>{
            textBtn.textContent = "Click vào đây điiii"
